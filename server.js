...
const tools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        work_status: {
          type: 'string',
          description: 'Job work status',
          enum: ['unscheduled', 'scheduled', 'in_progress', 'complete', 'completed', 'canceled', 'needs_scheduling'],
        },
...
const SERVER_INFO = { name: 'hcp-mcp-proxy', version: '1.0.0' };
...
// GET /:apikey/mcp — keep-alive SSE stream (some clients open this)
function handleSse(req, res) {
  ...
  // Initial empty event so connection establishes
